...
-- Last generated 2026-02-12 17:06:01
...
CREATE OR REPLACE VIEW v_authorities_role_list AS
    SELECT authorities_role_pkey, editnum, insby, insdatetime, modby, moddatetime, standard,authorities_workflow_fkey, name     FROM authorities_role;

CREATE OR REPLACE VIEW v_authorities_license_list AS
    SELECT authorities_license_pkey, editnum, insby, insdatetime, modby, moddatetime, standard, name     FROM authorities_license;
