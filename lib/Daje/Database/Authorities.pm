...
-- Last generated 2026-02-12 04:22:51
...
CREATE OR REPLACE VIEW v_authorities_plugin AS
    SELECT authorities_plugin_pkey, editnum, insby, insdatetime, modby, moddatetime, "full",
      name
...
CREATE OR REPLACE VIEW v_authorities_plugin_list AS
    SELECT authorities_plugin_pkey, editnum, insby, insdatetime, modby, moddatetime, "full", name     FROM authorities_plugin;
