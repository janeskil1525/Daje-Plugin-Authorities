...
-- Last generated 2026-02-10 05:06:15
...
CREATE TABLE IF NOT EXISTS authorities_role_function
(
    authorities_role_function_pkey  SERIAL NOT NULL,
    editnum bigint NOT NULL DEFAULT 1,
    insby character varying COLLATE pg_catalog."default" NOT NULL DEFAULT 'System'::character varying,
    insdatetime timestamp without time zone NOT NULL DEFAULT now(),
    modby character varying COLLATE pg_catalog."default" NOT NULL DEFAULT 'System'::character varying,
    moddatetime timestamp without time zone NOT NULL DEFAULT now(),
            authorities_function_fkey BIGINT  NOT NULL,
                    authorities_role_fkey BIGINT  NOT NULL,
                CONSTRAINT authorities_role_function_pkey PRIMARY KEY (authorities_role_function_pkey)
);
...
CREATE TABLE IF NOT EXISTS authorities_license_companies
(
    authorities_license_companies_pkey  SERIAL NOT NULL,
    editnum bigint NOT NULL DEFAULT 1,
    insby character varying COLLATE pg_catalog."default" NOT NULL DEFAULT 'System'::character varying,
    insdatetime timestamp without time zone NOT NULL DEFAULT now(),
    modby character varying COLLATE pg_catalog."default" NOT NULL DEFAULT 'System'::character varying,
    moddatetime timestamp without time zone NOT NULL DEFAULT now(),
            authorities_license_fkey BIGINT  NOT NULL,
                    companies_companies_fkey BIGINT  NOT NULL,
                CONSTRAINT authorities_license_companies_pkey PRIMARY KEY (authorities_license_companies_pkey)
);
...
CREATE OR REPLACE VIEW v_authorities_role AS
    SELECT authorities_role_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_workflow_fkey,
     companies_companies_fkey,
      name
          FROM authorities_role;
CREATE OR REPLACE VIEW v_authorities_role_function AS
    SELECT authorities_role_function_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_function_fkey,
     authorities_role_fkey
          FROM authorities_role_function;
CREATE OR REPLACE VIEW v_authorities_license AS
    SELECT authorities_license_pkey, editnum, insby, insdatetime, modby, moddatetime, default,
      name
...
CREATE OR REPLACE VIEW v_authorities_license_companies AS
    SELECT authorities_license_companies_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_license_fkey,
     companies_companies_fkey
          FROM authorities_license_companies;
...
CREATE OR REPLACE VIEW v_authorities_role_list AS
    SELECT authorities_role_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_workflow_fkey,companies_companies_fkey, name     FROM authorities_role;

CREATE OR REPLACE VIEW v_authorities_role_function_list AS
    SELECT authorities_role_function_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_function_fkey,authorities_role_fkey     FROM authorities_role_function;

CREATE OR REPLACE VIEW v_authorities_license_list AS
    SELECT authorities_license_pkey, editnum, insby, insdatetime, modby, moddatetime, default, name     FROM authorities_license;
...
CREATE OR REPLACE VIEW v_authorities_license_companies_list AS
    SELECT authorities_license_companies_pkey, editnum, insby, insdatetime, modby, moddatetime,authorities_license_fkey,companies_companies_fkey     FROM authorities_license_companies;
...
CREATE INDEX ind_companies_role_companies_fkey
    ...
    ALTER TABLE authorities_role_function
    ADD CONSTRAINT authorities_role_function_authorities_function_fkey
        FOREIGN KEY (authorities_function_fkey)    REFERENCES authorities_function (authorities_function_pkey);

CREATE INDEX ind_authorities_role_function_function_fkey
    ON authorities_role_function(authorities_function_fkey);

  ALTER TABLE authorities_role_function
    ADD CONSTRAINT authorities_role_function_authorities_role_fkey
        FOREIGN KEY (authorities_role_fkey)    REFERENCES authorities_role (authorities_role_pkey);

CREATE INDEX ind_authorities_role_function_role_fkey
    ON authorities_role_function(authorities_role_fkey);
...
CREATE INDEX ind_authorities_license_function_function_fkey
    ...
    ALTER TABLE authorities_license_companies
    ADD CONSTRAINT authorities_license_companies_authorities_license_fkey
        FOREIGN KEY (authorities_license_fkey)    REFERENCES authorities_license (authorities_license_pkey);

CREATE INDEX ind_authorities_license_companies_license_fkey
    ON authorities_license_companies(authorities_license_fkey);

  ALTER TABLE authorities_license_companies
    ADD CONSTRAINT companies_license_companies_companies_companies_fkey
        FOREIGN KEY (companies_companies_fkey)    REFERENCES companies_companies (companies_companies_pkey);


CREATE INDEX ind_companies_license_companies_companies_fkey
    ON authorities_license_companies(companies_companies_fkey);

  
    
-- Permissions
INSERT INTO authorities_permissions (permission, standard) VALUES 
('read', true),
('update', true),
('create', true),
('delete', true),
...
-- license
INSERT INTO license (name, default)  
VALUES ('full', true);
