package Daje::Database::Model::Super::AuthoritiesRoleUser;
...
# ====
#
# Daje::Database::Model::Super::AuthoritiesRoleUser - Daje db model
#
# SYNOPSIS
# ========
#
#
#       use Daje::Database::Model::Super::AuthoritiesRoleUser;
#
#       my $table = Daje::Database::Model::Super::AuthoritiesRoleUser->new(db => $db);
#
...
# ===========
#
# Daje::Database::Model::Super::AuthoritiesRoleUser is a Model super class
#
# METHODS
# =======
#
...
has 'fields' => '"authorities_role_user_pkey", "editnum", "insby", "insdatetime", "modby", "moddatetime",
"authorities_role_fkey",
"users_users_fkey"';
has 'primary_key_name' => "authorities_role_user_pkey";
has 'table_name' => "authorities_role_user";
has 'mandatory' => 'authorities_role_fkey,users_users_fkey,';
has 'workflow' => '';
