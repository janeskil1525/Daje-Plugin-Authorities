...
#       $app->helper(
#           v_authorities_role_user => sub {
#               state  $v_authorities_role_user = Daje::Database::Model::vAuthoritiesRoleUser->new(db => shift->pg->db)
#        });
#       $app->helper(
...
#        });
#       $app->helper(
#           v_authorities_role_function => sub {
#               state  $v_authorities_role_function = Daje::Database::Model::vAuthoritiesRoleFunction->new(db => shift->pg->db)
#        });
#       $app->helper(
...
#        });
#       $app->helper(
#           v_authorities_license_companies => sub {
#               state  $v_authorities_license_companies = Daje::Database::Model::vAuthoritiesLicenseCompanies->new(db => shift->pg->db)
#        });#
#       $app->helper(
#           v_authorities_role_user_list => sub {
#               state  $v_authorities_role_user_list = Daje::Database::Model::vAuthoritiesRoleUserList->new(db => shift->pg->db)
#        });
#       $app->helper(
...
#        });
#       $app->helper(
#           v_authorities_role_function_list => sub {
#               state  $v_authorities_role_function_list = Daje::Database::Model::vAuthoritiesRoleFunctionList->new(db => shift->pg->db)
#        });
#       $app->helper(
...
#        });
#       $app->helper(
#           v_authorities_license_companies_list => sub {
#               state  $v_authorities_license_companies_list = Daje::Database::Model::vAuthoritiesLicenseCompaniesList->new(db => shift->pg->db)
#        });#
# DESCRIPTION
# ===========
#
...
use Daje::Database::View::vAuthoritiesLicenseCompanies;# Lists
use Daje::Database::View::vAuthoritiesRoleUserList;
...
use Daje::Database::View::vAuthoritiesLicenseCompaniesList;
...
sub helpers($self, $app, $config) {
    ...
    $app->helper(
        v_authorities_role_user => sub {
            state  $v_authorities_role_user = Daje::Database::View::vAuthoritiesRoleUser->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_role => sub {
    ...
    $app->helper(
        v_authorities_role_function => sub {
            state  $v_authorities_role_function = Daje::Database::View::vAuthoritiesRoleFunction->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_license => sub {
    ...
    $app->helper(
        v_authorities_license_companies => sub {
            state  $v_authorities_license_companies = Daje::Database::View::vAuthoritiesLicenseCompanies->new(db => shift->pg->db)
        });    # Lists
    $app->helper(
        v_authorities_role_user_list => sub {
            state  $v_authorities_role_user_list = Daje::Database::View::vAuthoritiesRoleUserList->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_role_list => sub {
    ...
    $app->helper(
        v_authorities_role_function_list => sub {
            state  $v_authorities_role_function_list = Daje::Database::View::vAuthoritiesRoleFunctionList->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_license_list => sub {
    ...
    $app->helper(
        v_authorities_license_companies_list => sub {
            state  $v_authorities_license_companies_list = Daje::Database::View::vAuthoritiesLicenseCompaniesList->new(db => shift->pg->db)
        });}
