...
#        });
#       $app->helper(
#           v_authorities_role_company => sub {
#               state  $v_authorities_role_company = Daje::Database::Model::vAuthoritiesRoleCompany->new(db => shift->pg->db)
#        });
#       $app->helper(
...
#        });
#       $app->helper(
#           v_authorities_role_company_list => sub {
#               state  $v_authorities_role_company_list = Daje::Database::Model::vAuthoritiesRoleCompanyList->new(db => shift->pg->db)
#        });
#       $app->helper(
...
use Daje::Database::View::vAuthoritiesRoleCompany;
...
sub helpers($self, $app, $config) {
    ...
    $app->helper(
        v_authorities_role_company => sub {
            state  $v_authorities_role_company = Daje::Database::View::vAuthoritiesRoleCompany->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_role => sub {
    ...
    $app->helper(
        v_authorities_role_company_list => sub {
            state  $v_authorities_role_company_list = Daje::Database::View::vAuthoritiesRoleCompanyList->new(db => shift->pg->db)
        });
    $app->helper(
        v_authorities_role_list => sub {
